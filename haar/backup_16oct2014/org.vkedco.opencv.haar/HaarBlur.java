...
public class HaarBlur {
	...
	public static final void estimateImageBlur(Mat mat, double haar_thresh, double min_zero_thresh) {
		computeEmaps(mat);
		computeEmaxes();
	...
	public static final double getBlurExtent() { return mBLUR_EXTENT; }
